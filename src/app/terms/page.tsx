        ...
        content: [
          "Los precios actuales del servicio son:",
          {
            list: [
              ...
              "Usuarios pioneros (primeros 250 registrados por fecha de creación): publicaciones activas gratuitas durante 1 año desde su registro.",
            ],
          },
        ...
        content: [
          "Current service prices are:",
          {
            list: [
              ...
              "Pioneer users (first 250 registered by creation date): free active listings for 1 year from registration.",
            ],
          },
