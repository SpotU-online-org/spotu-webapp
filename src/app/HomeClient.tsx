        ...
        <section className="relative min-h-[85vh] flex items-center overflow-hidden">
          ...
          <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8 lg:py-36">
            <div className="mx-auto max-w-3xl text-center">
              {/* Early access badge */}
              <div className="animate-fade-in-up mb-3 inline-flex items-center gap-2 rounded-full border border-amber-300/40 bg-amber-50 px-4 py-1.5 text-sm text-amber-700">
