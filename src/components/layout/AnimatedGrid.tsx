...
export function AnimatedGrid() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <div className="absolute -bottom-40 -left-40 h-[400px] w-[400px] rounded-full bg-coral/8 blur-[120px] animate-pulse [animation-delay:2s]" />
      <div className="absolute top-1/2 left-1/3 -translate-x-1/2 -translate-y-1/2 h-[300px] w-[300px] rounded-full bg-primary/5 blur-[100px] animate-pulse [animation-delay:4s]" />
