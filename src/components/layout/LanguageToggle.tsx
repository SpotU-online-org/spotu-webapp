...
const TRANSLATIONS: Record<string, Record<Locale, string>> = {
  ...
  "pricing.subtitle": {
    es: "Publica tu primera publicación gratis por 30 días. Luego elige el plan que mejor te describe.",
    en: "Publish your first listing free for 30 days. Then choose the plan that best describes you.",
  },
  "pricing.monthly": { es: "mes", en: "mo" },
  "pricing.week": { es: "semana", en: "week" },
  "pricing.free_trial": { es: "30 días gratis", en: "30 days free" },
  "pricing.free_trial_note": { es: "Primera publicación. Requiere tarjeta.", en: "First listing. Card required." },
  ...
  "pricing.plan.spaces.desc": {
    es: "Para dueños de espacios publicitarios físicos o digitales, y anunciantes que buscan conectar.",
    en: "For owners of physical or digital ad spaces, and advertisers looking to connect.",
  },
  "pricing.plan.agency.name": { es: "Agencias", en: "Agencies" },
  "pricing.plan.agency.desc": {
    es: "Para agencias de marketing y servicios profesionales de publicidad.",
    en: "For marketing agencies and professional advertising services.",
  },
  "pricing.plan.agency.popular": { es: "Para agencias", en: "For agencies" },
